...
<body>
 ...
 <section id="title" class="emerald">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ul class="breadcrumb pull-right">
						...
						<li class="active">Malla Ingenieria de Ejecucion en Informatica</li>
                    </ul>
                </div>
            </div>
        </div>
  ...
  <tr>
   ...
   <tr>
    <td colspan="20" >Plan Ingenieria de Ejecucion en Informatica</td>
  </tr>
  <tr>
    <td>1° Sem.</td>
 ...
 <tr>
   <td>INC100 Algebra Elemental</td>
    ...
    <td>R: 201</td>
    <td>IEJ300 Probabilidades Y Estadicticas</td>
    <td>R: 301</td>
    <td>IEJ310 Sistema de Base de Datos</td>
    <td>R: 310</td>
    <td>IEJ400 Taller de Base de Datos</td>
    <td>R: 403</td>
    <td>IEJ410 Arquitectura de Software</td>
   </tr>
   <tr>
     <td></td>
    <td>R:</td>
