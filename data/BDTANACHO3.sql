...
CREATE TABLE IF NOT EXISTS `mydb`.`asignatura` (
  ...
  PRIMARY KEY (`nombre`, `semestre_semestre`, `malla_idMalla`, `descargas_idDescargas`),
  INDEX `fk_asignatura_semestre1_idx` (`semestre_semestre` ASC),
  INDEX `fk_asignatura_malla1_idx` (`malla_idMalla` ASC),
  INDEX `fk_asignatura_descargas1_idx` (`descargas_idDescargas` ASC),
  ...
  CONSTRAINT `fk_asignatura_malla1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_asignatura_descargas1`
...
CREATE TABLE IF NOT EXISTS `mydb`.`mencion` (
  ...
  `descrip` TEXT NOT NULL,
  `malla_idMalla` VARCHAR(3) NOT NULL,
  PRIMARY KEY (`idMencion`, `malla_idMalla`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`asig_mencion` (
  ...
  PRIMARY KEY (`idCodigo`, `mencion_idMencion`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`usuario_alumno` (
  `nombre` INT NOT NULL,
  `id_malla` VARCHAR(45) NOT NULL,
  `usuario_rut` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`usuario_rut`),
  CONSTRAINT `fk_usuario_alumno_usuario1`
    FOREIGN KEY (`usuario_rut`)
    REFERENCES `mydb`.`usuario` (`rut`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `mydb`.`malla_has_usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`malla_has_usuario` ;

CREATE TABLE IF NOT EXISTS `mydb`.`malla_has_usuario` (
  `malla_idMalla` VARCHAR(3) NOT NULL,
  `usuario_rut` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`malla_idMalla`, `usuario_rut`),
  INDEX `fk_malla_has_usuario_usuario1_idx` (`usuario_rut` ASC),
  INDEX `fk_malla_has_usuario_malla1_idx` (`malla_idMalla` ASC),
  CONSTRAINT `fk_malla_has_usuario_malla1`
    FOREIGN KEY (`malla_idMalla`)
    REFERENCES `mydb`.`malla` (`idMalla`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_malla_has_usuario_usuario1`
    FOREIGN KEY (`usuario_rut`)
    REFERENCES `mydb`.`usuario` (`rut`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `mydb`.`avance` (
  ...
  `codigo_malla` VARCHAR(3) NOT NULL,
  `numero` INT NOT NULL,
  `usuario_alumno_usuario_rut` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`usuario_alumno_usuario_rut`, `nombre`),
  INDEX `fk_avance_usuario_alumno1_idx` (`usuario_alumno_usuario_rut` ASC),
  CONSTRAINT `fk_avance_usuario_alumno1`
    FOREIGN KEY (`usuario_alumno_usuario_rut`)
    REFERENCES `mydb`.`usuario_alumno` (`usuario_rut`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
-- -----------------------------------------------------
-- Table `mydb`.`descargas_has_usuario`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`descargas_has_usuario` ;

CREATE TABLE IF NOT EXISTS `mydb`.`descargas_has_usuario` (
  `descargas_idDescargas` INT(11) NOT NULL,
  `usuario_rut` VARCHAR(9) NOT NULL,
  PRIMARY KEY (`descargas_idDescargas`, `usuario_rut`),
  INDEX `fk_descargas_has_usuario_usuario1_idx` (`usuario_rut` ASC),
  INDEX `fk_descargas_has_usuario_descargas1_idx` (`descargas_idDescargas` ASC),
  CONSTRAINT `fk_descargas_has_usuario_descargas1`
    FOREIGN KEY (`descargas_idDescargas`)
    REFERENCES `mydb`.`descargas` (`idDescargas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_descargas_has_usuario_usuario1`
    FOREIGN KEY (`usuario_rut`)
    REFERENCES `mydb`.`usuario` (`rut`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
