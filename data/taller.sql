...
CREATE TABLE IF NOT EXISTS `mydb`.`malla` (
  ...
  PRIMARY KEY (`idMalla`),
  INDEX `fk_malla_usuario_administrador1_idx` (`usuario_administrador_rut` ASC),
  CONSTRAINT `fk_malla_usuario_administrador1`
    FOREIGN KEY (`usuario_administrador_rut`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`descargas` (
  ...
  INDEX `fk_descargas_usuario_administrador1_idx` (`usuario_administrador_rut` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`usuario_alumno` (
  ...
  `malla_idMalla` VARCHAR(3) NOT NULL,
  PRIMARY KEY (`rut`),
  INDEX `fk_usuario_alumno_malla1_idx` (`malla_idMalla` ASC),
  CONSTRAINT `fk_usuario_alumno_malla1`
    FOREIGN KEY (`malla_idMalla`)
    REFERENCES `mydb`.`malla` (`idMalla`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
